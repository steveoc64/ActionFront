...
func CreateGameData(gameData *db.Col) {
	...
	gameData.Insert(DataMap("Cavalry", Cavalry{"France Guard", 1808, 1809, "Polish Guard Light Horse", "OldGuard", 32, 5, "Light", "Excellent"}))
	...
	// Corps Orders
	gameData.Insert(DataMap("CorpsOrder", CorpsOrder{"Attack", []string{"Attack", "Bombard", "Support", "Intercept", "March"}, "At least 1 ME must attempt to engage."}))
	...
	gameData.Insert(DataMap("CorpsOrder", CorpsOrder{"Manoeuvre", []string{"Support", "Intercept", "March", "Screen"}, "The Corps will march to a new location"}))
	...
	// ME Orders
	gameData.Insert(DataMap("MEOrder", MEOrder{"Attack", "The ME is to engage the enemy", "The ME advances to contact", true, true, false, false, false}))
	...
	gameData.Insert(DataMap("MEOrder", MEOrder{"Bombard", "The ME conducts softening up of the objective", "The ME will advance to within 3 grids of the objective and conduct bombardment and skirmish attacks. Pending order of Attack after a specified period.", true, true, false, true, false}))
	...
	gameData.Insert(DataMap("MEOrder", MEOrder{"Support", "The ME is to support another ME", "May join the attack or defence when the supported unit is engaged", true, false, false, true, false}))
	gameData.Insert(DataMap("MEOrder", MEOrder{"Intercept", "The ME is to support another ME", "Intercept order may be activated when enemy is within 3 grids", true, false, true, true, false}))
	gameData.Insert(DataMap("MEOrder", MEOrder{"March", "The ME is to march to a new position", "Will move up to 2 grids off line to avoid contact. Revert to Defend or BreakOff if engaged", true, false, false, true, true}))
	...
	gameData.Insert(DataMap("MEOrder", MEOrder{"ReDeploy", "The ME is to perform a general change of facing, formation and relative position", "Shaken if engaged. Receive 3D6 GT adjustments per half hour", true, false, false, true, true}))
	...
	gameData.Insert(DataMap("CommanderAction", CommanderAction{"Corps", "DEF", "Convert Manoeuvre to Defend during GT movement", 1}))
	...
	gameData.Insert(DataMap("MEFatigueMod", MEFatigueMod{"EC", "Extreme Heat/Cold", 2}))
	...
	gameData.Insert(DataMap("FormSquare", FormSquare{1, "OldGuard", "AttackColumn", 13, 5, -1, -5}))
	gameData.Insert(DataMap("FormSquare", FormSquare{2, "OldGuard", "ClosedColumn", 14, 9, 7, 5}))
	gameData.Insert(DataMap("FormSquare", FormSquare{3, "OldGuard", "Line", 16, 12, 10, 9}))
	...
	gameData.Insert(DataMap("FormSquare", FormSquare{7, "Grenadier", "AttackColumn", 15, 7, 1, -3}))
	gameData.Insert(DataMap("FormSquare", FormSquare{8, "Grenadier", "ClosedColumn", 16, 11, 9, 7}))
	gameData.Insert(DataMap("FormSquare", FormSquare{9, "Grenadier", "Line", 18, 14, 12, 11}))

	gameData.Insert(DataMap("FormSquare", FormSquare{10, "Elite", "AttackColumn", 14, 9, 7, 1}))
	gameData.Insert(DataMap("FormSquare", FormSquare{11, "Elite", "ClosedColumn", 16, 11, 9, 7}))
	gameData.Insert(DataMap("FormSquare", FormSquare{12, "Elite", "Line", 21, 13, 12, 10}))
	gameData.Insert(DataMap("FormSquare", FormSquare{13, "CrackLine", "AttackColumn", 14, 9, 8, 2}))
	gameData.Insert(DataMap("FormSquare", FormSquare{14, "CrackLine", "ClosedColumn", 16, 11, 10, 8}))
	gameData.Insert(DataMap("FormSquare", FormSquare{15, "CrackLine", "Line", 21, 13, 12, 11}))
	...
	gameData.Insert(DataMap("FormSquare", FormSquare{19, "Regular", "AttackColumn", 16, 11, 9, 3}))
	gameData.Insert(DataMap("FormSquare", FormSquare{20, "Regular", "ClosedColumn", 18, 13, 11, 9}))
	gameData.Insert(DataMap("FormSquare", FormSquare{21, "Regular", "Line", 23, 15, 14, 12}))

	gameData.Insert(DataMap("FormSquare", FormSquare{22, "Conscript", "AttackColumn", 17, 13, 11, 10}))
	gameData.Insert(DataMap("FormSquare", FormSquare{23, "Conscript", "ClosedColumn", 21, 15, 13, 11}))
	gameData.Insert(DataMap("FormSquare", FormSquare{24, "Conscript", "Line", 26, 17, 15, 14}))
	gameData.Insert(DataMap("FormSquare", FormSquare{25, "Landwehr", "AttackColumn", 18, 15, 13, 12}))
	gameData.Insert(DataMap("FormSquare", FormSquare{26, "Landwehr", "ClosedColumn", 22, 17, 15, 13}))
	gameData.Insert(DataMap("FormSquare", FormSquare{27, "Landwehr", "Line", 27, 18, 16, 15}))
	...
	gameData.Insert(DataMap("FormSquare", FormSquare{31, "Rabble", "AttackColumn", 22, 19, 17, 16}))
	gameData.Insert(DataMap("FormSquare", FormSquare{32, "Rabble", "ClosedColumn", 27, 23, 19, 18}))
	gameData.Insert(DataMap("FormSquare", FormSquare{33, "Rabble", "Line", 29, 27, 20, 19}))
	...
	gameData.Insert(DataMap("FormSquareMod", FormSquareMod{"SG", "Stand Ground Instead", 8}))
	gameData.Insert(DataMap("FormSquareMod", FormSquareMod{"FA", "Per fatigue level over Fresh", -1}))
	gameData.Insert(DataMap("FormSquareMod", FormSquareMod{"HIT", "Per HIT", -1}))
	...
	gameData.Insert(DataMap("ArtLimber", ArtLimber{1, "IC", "Infantry Close", 12, "1 Quadrant"}))
	...
	gameData.Insert(DataMap("ArtLimber", ArtLimber{5, "CC", "Cavalry Close", 18, "1 Quadrant"}))
	...
	gameData.Insert(DataMap("ShockValue", ShockValue{33, "", 33}))
	...
	gameData.Insert(DataMap("Injury", Injury{2, 1, "Escape", "Shell explodes directly overhead, hitting several ADCs. General is untouched"}))
	gameData.Insert(DataMap("Injury", Injury{2, 2, "Death", "At full gallop across the battlefield, the General turns to answer a question, he fails to notice a low branch a neck height. Falls to the ground .. dead"}))
	gameData.Insert(DataMap("Injury", Injury{2, 3, "Death", "This is Warm Work says the General as he takes a long drink from a flask of wine aquired last night. Moments later he is doubled over, wrenching from the enemy assassins poison"}))
	gameData.Insert(DataMap("Injury", Injury{2, 4, "Death", "Suffering from an unexpected heart attack, the General expires from this world"}))
	gameData.Insert(DataMap("Injury", Injury{2, 5, "Death", "A cannonball narrowly misses the General, striking a nearby tree. A barrage of splinters however manage to tear through the Generals heart. His Aides watch helplessly as he bleeds to death"}))
	gameData.Insert(DataMap("Injury", Injury{2, 6, "Death", "A sniper hits the General in the chest. Fearing the wound is fatal, the General straps himself to his horse so as not to dismay his men as he dies. No morale check required upon his death"}))
	gameData.Insert(DataMap("Injury", Injury{3, 1, "Death", "Horse is shot, it rears and lands on the General."}))
	gameData.Insert(DataMap("Injury", Injury{3, 2, "Death", "The Generals honour is impunged, he rides forward to seek Death, who waits for him eagerly in the fog of battle"}))
	gameData.Insert(DataMap("Injury", Injury{3, 3, "Death", "A previous blow to the head has weakened a blood vessel. It breaks suddenly, leading to a cerebral hemorrhage"}))
	gameData.Insert(DataMap("Injury", Injury{3, 4, "Death", "The General has learned this morning that he is to be court martialled on charges of embezzlement. The loss of honour finally overcomes the General, who restores his honour with his trusty pistol"}))
	gameData.Insert(DataMap("Injury", Injury{3, 5, "Serious", "Whilst conferring with an Aide, the General is struck in the left leg by a cannonball. By Jove I have lost a leg ! Indeed you have sir !"}))
	gameData.Insert(DataMap("Injury", Injury{3, 6, "Stunned", "Grazed across the head by a bullet, the General is severely stunned and overcome with ammnesia. Out for the day"}))
	gameData.Insert(DataMap("Injury", Injury{4, 1, "Death", "A sniper shoots the General through the heart, he collapses and dies like a dog"}))
	gameData.Insert(DataMap("Injury", Injury{4, 2, "Critical", "A sniper shoots the General through the shoulder, severing an artery. He may live, or he may not !"}))
	gameData.Insert(DataMap("Injury", Injury{4, 3, "Death", "A cannonball straight through the chest appears to have no effect on the General ... for but a brief moment only"}))
	gameData.Insert(DataMap("Injury", Injury{4, 4, "Captured", "Riding over to where he sees friendly cavalry, the nearsighted General rides straight into the waiting arms of the enemy"}))
	gameData.Insert(DataMap("Injury", Injury{4, 5, "Light", "The General takes a bullet to the back of the thigh, nothing broken"}))
	gameData.Insert(DataMap("Injury", Injury{4, 6, "Death", "The General has just received proof of his wifes infidelity. With rage, he rides headlong into the lines of the enemy"}))
	gameData.Insert(DataMap("Injury", Injury{5, 1, "Serious", "A cannonball strikes a wagon, sending a hot shard of metal into the Generals gut, where it punctures a kidney. He will urinate blood for days, if he lives"}))
	gameData.Insert(DataMap("Injury", Injury{5, 2, "Critical", "A ricochetting cannonball hit the General from behind, tearing through his buttocks"}))
	gameData.Insert(DataMap("Injury", Injury{5, 3, "Critical", "A bullet through the neck slices through the windpipe, deflects, and lodges into a rear rib"}))
	gameData.Insert(DataMap("Injury", Injury{5, 4, "Light", "A bullet through the thigh lodges against the femur"}))
	gameData.Insert(DataMap("Injury", Injury{5, 5, "Slowed", "The General strains his back whilst jumping an obstacle on his horse. Half move for the rest of the day"}))
	gameData.Insert(DataMap("Injury", Injury{5, 6, "Death", "The General is disembowelled by a nasty shard of shrapnell"}))
	gameData.Insert(DataMap("Injury", Injury{6, 1, "Death", "A cannonball passes clean through the Generals spine"}))
	gameData.Insert(DataMap("Injury", Injury{6, 2, "Captured", "The General wishes to take a look at the situation. To avoid attracting attention, he takes a single aide. Ambushed by skirmishers, the Aide is killed and the General captured"}))
	gameData.Insert(DataMap("Injury", Injury{6, 3, "Light", "A Cannonball ricochetts off the ground, and strikes the Generals shin"}))
	gameData.Insert(DataMap("Injury", Injury{6, 4, "Critical", "A Cannonballs strikes a nearby tree, sending splinters into the Generals neck"}))
	gameData.Insert(DataMap("Injury", Injury{6, 5, "Critical", "The General stops a cannonball with his knee"}))
	gameData.Insert(DataMap("Injury", Injury{6, 6, "Serious", "Shrapnel from a nearby cannonball cause the loss of the Generals left eye"}))
	gameData.Insert(DataMap("Injury", Injury{7, 1, "Critical", "The General is intentionally shot by his own men. (Ignore if Inspirational or better)"}))
	gameData.Insert(DataMap("Injury", Injury{7, 2, "Critical", "The General loses a leg to a cannonball"}))
	gameData.Insert(DataMap("Injury", Injury{7, 3, "Light", "A bullet glances off the Generals left shoulder. Good thing he is right handed"}))
	gameData.Insert(DataMap("Injury", Injury{7, 4, "Stunned", "The General suffers a gall bladder attack. Out for 2 hours"}))
	gameData.Insert(DataMap("Injury", Injury{7, 5, "Critical", "A bullet strikes the Generals shoulder blade, causing massive bleeding"}))
	gameData.Insert(DataMap("Injury", Injury{7, 6, "Critical", "The General loses his left foot to a stray cannonball"}))
	gameData.Insert(DataMap("Injury", Injury{8, 1, "Death", "The General is looking through his spyglass, when a freak bullet passes through its length, and into the Generals brain through his eye. Rather unlucky !"}))
	gameData.Insert(DataMap("Injury", Injury{8, 2, "Light", "The General dismounts to adjust his saddle straps. Stepping in a hole he sprains his ankle"}))
	gameData.Insert(DataMap("Injury", Injury{8, 3, "Stunned", "A large cannonball appears to hit the General full in the forehead. The General rises moments later, but is stunned for the day. Witnesses claim that the cannonball bounced off his head !"}))
	gameData.Insert(DataMap("Injury", Injury{8, 4, "Critical", "A snipers bullet finds the Generals chest, but is stopped just short of his still beating heart"}))
	gameData.Insert(DataMap("Injury", Injury{8, 5, "Serious", "A howitzer round spooks the Generals horse. The General is thrown but catches his foot in the stirrup. He is dragged ignominously for some distance before he is freed from the horse"}))
	gameData.Insert(DataMap("Injury", Injury{8, 6, "Serious", "Seeking the shelter of the shade, a bough is blown from the tree, striking the General in the head"}))
	gameData.Insert(DataMap("Injury", Injury{9, 1, "Serious", "Riding near a copse of trees, the General is struck by a bullet from deserters"}))
	gameData.Insert(DataMap("Injury", Injury{9, 2, "Light", "The General takes a bullet to the wrist"}))
	gameData.Insert(DataMap("Injury", Injury{9, 3, "Serious", "The General takes a bullet to the arm, breaking the bone and slicing an artery"}))
	gameData.Insert(DataMap("Injury", Injury{9, 4, "Light", "A bullet grazes the Generals arm, and breaks two ribs. Ouch !"}))
	gameData.Insert(DataMap("Injury", Injury{9, 5, "Light", "A bullet takes an ugly gouge out of the Generals nose"}))
	gameData.Insert(DataMap("Injury", Injury{9, 6, "Light", "The General is thrown from his horse, injuring his knee"}))
	gameData.Insert(DataMap("Injury", Injury{10, 1, "Action", "The Generals horse bolts, leaving him without a mount. General retires to reserve area to remount"}))
	gameData.Insert(DataMap("Injury", Injury{10, 2, "Serious", "The Generals horse bolts, startled friendly troops shoot at the General, riddling him with bullets"}))
	gameData.Insert(DataMap("Injury", Injury{10, 3, "Light", "The General is hit in the finger, which he binds with an expensive cravat. He remains bravely on the field"}))
	gameData.Insert(DataMap("Injury", Injury{10, 4, "Critical", "As the General passes a tree, it explodes from the passage of a cannonball. A large splinter lodges in his stomach. Not good !"}))
	gameData.Insert(DataMap("Injury", Injury{10, 5, "Light", "The General turns to talk to an ADC, and misses a low tree branch, which strikes him in the head. After a brief treatment for concussion, he returns to his post"}))
	gameData.Insert(DataMap("Injury", Injury{10, 6, "Death", "When jumping a stump, the horse falls on the General, breaking his back"}))
	gameData.Insert(DataMap("Injury", Injury{11, 1, "Escape", "A nearby cannonball strikes a rock, sending a shower of stones over the General and his aides. A rock strikes the General in the neck, which he brushes off as nothing"}))
	gameData.Insert(DataMap("Injury", Injury{11, 2, "Light", "A nearby cannonball strikes the ground, temporarily blinding the General in a shower of sand"}))
	gameData.Insert(DataMap("Injury", Injury{11, 3, "Critical", "A nearby cannonball strikes a rock, sending a shower of stones over the General and his aides. A rock strikes the General in the neck, which he brushes off as nothing. Moments later hower, he reels and faints, with blood pouring from his wound"}))
	gameData.Insert(DataMap("Injury", Injury{11, 4, "Light", "A nearby cannonball strikes a rock, startling his horse and throwing the General in a most ignominous manner"}))
	gameData.Insert(DataMap("Injury", Injury{11, 5, "Escape", "A nearby cannonball convinces the General that the enemy guns have found their range. This convinces him to relocate to cover in a hurry"}))
	gameData.Insert(DataMap("Injury", Injury{11, 6, "Escape", "A nearby cannonball strikes a rock, with the bulk of the shards seeking out his most trusted ADC. The General spends the remainder of the turn urgently attending to his ADC"}))
	gameData.Insert(DataMap("Injury", Injury{12, 1, "Light", "The General feels feint, and must remove himself from the chain of command for an hour, for rest and liquid nourishment"}))
	gameData.Insert(DataMap("Injury", Injury{12, 2, "Drunk", "The General is drunk (again), -2 on all leader and commander action rolls for the next 2 hours"}))
	gameData.Insert(DataMap("Injury", Injury{12, 3, "Light", "The General is thrown from his horse, painfully jarring his back. Out of action for 1 hour"}))
	gameData.Insert(DataMap("Injury", Injury{12, 4, "Escape", "A musket ball strikes the Generals hat, causing the feathers of the plume to fall to the ground like so many flakes of snow"}))
	gameData.Insert(DataMap("Injury", Injury{12, 5, "Serious", "The stomach cramps from last night are worsening, the General must reluctantly retire from the field for the day. Could be bad"}))
	gameData.Insert(DataMap("Injury", Injury{12, 6, "Light", "The horse is hit by a round and rolls onto the Generals foot, breaking it"}))
	gameData.Insert(DataMap("Injury", Injury{13, 1, "Light", "A cannon round strikes a nearby cart, sending splinters in all directions. One such splinter finds a new home in the Generals shoulder"}))
	gameData.Insert(DataMap("Injury", Injury{13, 2, "Light", "A bullet strikes the General in the side of his ear, removing the earlobe. Lots of blood, but nothing serious. Be sure not to allow infection to take hold, as gangrene of the ear can be bad luck"}))
	gameData.Insert(DataMap("Injury", Injury{13, 3, "Light", "A cannonball passes clean through the Generals hat, singing his hair and almost stopping his heart. The General spends 1 turn finding a new hat"}))
	gameData.Insert(DataMap("Injury", Injury{13, 4, "Serious", "A cannonball hits a nearby cart, sending a splinter into the Generals chest"}))
	gameData.Insert(DataMap("Injury", Injury{13, 5, "Light", "A bullet strikes the Generals epaulette, and ricochets upwards to cleave off his ear as well. Shocking, but clearly very lucky"}))
	gameData.Insert(DataMap("Injury", Injury{13, 6, "Serious", "A howitzer round explodes overhead. A peice of shrapnel passes through the Generals shoulder and into his chest"}))
	gameData.Insert(DataMap("Injury", Injury{14, 1, "Light", "The General is hit in the shoulder by a musket ball"}))
	gameData.Insert(DataMap("Injury", Injury{14, 2, "Escape", "Another favorite ADC of the General is struck down by a stray bullet. The General escorts his friend from the field for the next turn"}))
	gameData.Insert(DataMap("Injury", Injury{14, 3, "Light", "The General is hit in the hip by a spent ball"}))
	gameData.Insert(DataMap("Injury", Injury{14, 4, "Slowed", "A case of the piles catches up with the General"}))
	gameData.Insert(DataMap("Injury", Injury{14, 5, "Death", "Riding too close the enemy line, the General is struck by an unexpected fusilade. His horse turns and runs to the rear. A short time later, blood is seen pouring from the Generals lips, before he pitches forward and falls to the ground with a solid thump"}))
	gameData.Insert(DataMap("Injury", Injury{14, 6, "Light", "The General is hit in the head by a spent ball. 'Now you will have to write the letters to my wife' he says to his aide"}))
	gameData.Insert(DataMap("Injury", Injury{15, 1, "Slowed", "A recurring case of dysentry sidelines the General for an hour"}))
	gameData.Insert(DataMap("Injury", Injury{15, 2, "Inspired", "The General is hit on the crown of the head. After dressing the wound, the General returns to his troops with a bloodied bandage across his head. +1 to close action fights"}))
	gameData.Insert(DataMap("Injury", Injury{15, 3, "Uninspired", "The General is hit in the chin by a spent ball, breaking his jaw. No longer able to speak, he is classes as impersonal for the remainder of the battle"}))
	gameData.Insert(DataMap("Injury", Injury{15, 4, "Stunned", "The General is incapacitated with a chronic case of epilepsy. No orders or CAs for 2 hours"}))
	gameData.Insert(DataMap("Injury", Injury{15, 5, "Light", "The General is hit in the calf by a rock splinter, causing a painful bruise"}))
	gameData.Insert(DataMap("Injury", Injury{15, 6, "Death", "A round passes through the Generals mouth, and straight through the base of his neck. He dies with a most surprised look on his face"}))
	gameData.Insert(DataMap("Injury", Injury{16, 1, "Drunk", "The General is drunk (again). A further -2 on all CA rolls for the next 2 hours"}))
	gameData.Insert(DataMap("Injury", Injury{16, 2, "Light", "The General is hit in the backside. 'This will make staff meetings Hell' he quips"}))
	gameData.Insert(DataMap("Injury", Injury{16, 3, "Death", "The Generals horse is hit, he rears and falls onto the General with great force, breaking his neck"}))
	gameData.Insert(DataMap("Injury", Injury{16, 4, "Light", "An unfavoured ADC is struck by a cannonball, no great loss. However, splinters from bone fragments strike the General, causing a light wound"}))
	gameData.Insert(DataMap("Injury", Injury{16, 5, "Light", "A bullet grazes the Generals stomach, removing buttons from his jacket. 'If I had missed dinner last night, the round would have missed' he quips"}))
	gameData.Insert(DataMap("Injury", Injury{16, 6, "Light", "A shell fragment strikes the General in the foot, causing an awkward limp for the next month"}))
	gameData.Insert(DataMap("Injury", Injury{17, 1, "Death", "A bullet strikes the General in the collarbone and ricochets up into the brain"}))
	gameData.Insert(DataMap("Injury", Injury{17, 2, "Light", "A bullet strikes the Generals cheek bone, leavin a rakish scar"}))
	gameData.Insert(DataMap("Injury", Injury{17, 3, "Stunned", "A favorite ADC is killed, leaving the General overcome with grief for the following hour"}))
	gameData.Insert(DataMap("Injury", Injury{17, 4, "Light", "A bullet strikes the Generals scabbard, causing a bad bruise"}))
	gameData.Insert(DataMap("Injury", Injury{17, 5, "Light", "The General is hit in the arm by a spent ball"}))
	gameData.Insert(DataMap("Injury", Injury{17, 6, "Light", "A musket ball removes part of the Generals foot"}))
	gameData.Insert(DataMap("Injury", Injury{18, 1, "Stunned", "The General recieves a (false) report that he has been relieved. He heads back to Army HQ for further explanation. After a time, the matter is truth is unravelled and he returns to his post"}))
	gameData.Insert(DataMap("Injury", Injury{18, 2, "Death", "The General is hit in the hip by a cannonball. He falls to the ground, and quips 'this will put a cramp on my dancing style', before bravely bleeding out"}))
	gameData.Insert(DataMap("Injury", Injury{18, 3, "Stunned", "Dirt is kicked up into the Generals eye. He retired for one turn to treat this most inconvenient injury"}))
	gameData.Insert(DataMap("Injury", Injury{18, 4, "Death", "The General is riding towards the front when a bullet strikes him in the heart, killing him like a dog"}))
	gameData.Insert(DataMap("Injury", Injury{18, 5, "Serious", "Ther General is thrown from his horse, breaking his clavicle"}))
	gameData.Insert(DataMap("Injury", Injury{18, 6, "Critical", "A ball kicks along the ground, sending rocks in all directions. One enters the Generals eye, half blinding him"}))
	gameData.Insert(DataMap("Injury", Injury{19, 1, "Inspired", "A sarcastic comment is overhead. The General attaches himself to the nearest unit amd leads with +1 inspiration for the remains of the day"}))
	gameData.Insert(DataMap("Injury", Injury{19, 2, "Light", "A bullet deflects off the Generals arm into his shoulder"}))
	gameData.Insert(DataMap("Injury", Injury{19, 3, "Escape", "A howizter round hits the Generals horse in the chest, enters the horse and explodes inside the poor beast, hurling the General through the air. Remarkably the General is but stunned for 1 turn, otherwise unharmed"}))
	gameData.Insert(DataMap("Injury", Injury{19, 4, "Serious", "A bullet crushes the Generals elbow"}))
	gameData.Insert(DataMap("Injury", Injury{19, 5, "Stunned", "The General is last seen riding into action at the head of his troops. His horse returns spattered in blood, the worst is feared. Later that night, the General returns to camp, reporting having been knocked out cold during the battle"}))
	gameData.Insert(DataMap("Injury", Injury{19, 6, "Light", "The horse comes up short suddenly, slamming the General into the saddle"}))
	gameData.Insert(DataMap("Injury", Injury{20, 1, "Death", "A ball kicks along the ground sending rocks in all directions. One enters the Generals eye and penetrates the brain"}))
	gameData.Insert(DataMap("Injury", Injury{20, 2, "Serious", "A bullet skips off the Generals saddle and enters his groin. He will only be half a man ... if he lives"}))
	gameData.Insert(DataMap("Injury", Injury{20, 3, "Death", "As he turns in the saddle the General is shot through both lungs. He turns to an aide and asks that he place him beneath a tree facing the enemy 'So I might see our Victory before I die'"}))
	gameData.Insert(DataMap("Injury", Injury{20, 4, "Inspired", "A spent round knocks the General off his horse. 'It seems the enemy wants me to fight this battle dismounted .. so be it'. +2 to morale checks for remainder of battle"}))
	gameData.Insert(DataMap("Injury", Injury{20, 5, "Escape", "In the midst of a relihous vision, the General retires from the field. He eventually enters a monastery"}))
	gameData.Insert(DataMap("Injury", Injury{20, 6, "Critical", "A slow rolling cannonball suddenly kicks up and knocks the General in the chest. He appears unharmed ... for now"}))
	...
	gameData.Insert(DataMap("Supply", Supply{"S1", "Sapper / Engineer - per Company", 2, 2, 5, 1}))
	gameData.Insert(DataMap("Supply", Supply{"S2", "Supply and Baggage - per Train", 5, 0, 10, 5}))

	/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	// Commanders Database

	gameData.Insert(DataMap("Commander", Commander{"France", "Napoleon I", 3, 3, 3}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Arrighi de Casanova", -3, 1, 1}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Augereau - to 1807", -1, 1, 1}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Augereau - after 1807", -1, -1, 0}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Baraguey d'Hillier", -3, 0, 0}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Alexandre Beauharnais", -2, -2, 1}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Bernadotte", -3, 0, 0}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Berthier", 0, 0, 0}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Bertrand", -3, 0, 0}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Bessieres", 0, 0, 1}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Beurnonville", 0, 0, 1}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Bonchamps", 0, 0, 1}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Brune", 0, 0, 1}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Cadoudal", 0, 0, 1}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Caffarelli", -1, -1, 0}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Caulaincourt", -3, 1, 1}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Canclaux", -1, -1, 0}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Carteux", -1, 0, 0}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Cathelineau", 0, 0, 3}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Championnet", 0, 0, 1}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Clauzel", 1, 0, 1}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Charette", 2, 2, 1}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Prince d'Conde", -1, -1, 1}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Custine", 0, 0, 0}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Dampierre", -1, -1, -1}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Daoust", -1, -1, 0}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Davout", 2, 3, 0}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Decaen", 1, 1, 1}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Dombrowski", -3, 0, 1}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Desnouettes", -3, 0, 1}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Doppet", -1, -1, 0}))

	gameData.Insert(DataMap("Commander", Commander{"France", "Dorsenne", -1, 0, 1}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Drouet d'Erlon", -3, 0, 1}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Drouot", -3, 1, 0}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Dugommier", 0, 0, 0}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Dupont", -1, 1, 0}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Duhesme", -1, 0, 1}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Dumouriez", 1, 1, 0}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Elbee", 0, 0, 1}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Eugene de Beauharnais", 1, 1, 1}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Exelmans", -3, 1, 0}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Gazan", -1, 0, 1}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Gerard", -3, 0, 1}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Grenier", -3, 0, 0}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Grouchy", 0, 2, 1}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Heudelet", -3, 0, 0}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Hoche", 1, 1, 1}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Houchard", 0, 0, 1}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Humbert", -1, -2, 0}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Jerome Bonaparte", -2, -1, 1}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Joseph Bonaparte", -1, -1, 0}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Jourdan - till 1800", 0, 0, 0}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Jourdan - after 1800", -1, 0, 0}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Joubert", 0, 1, 1}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Junot", -1, 0, 1}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Marshall Kellerman", 0, 0, 0}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Kellerman (the son)", -3, 2, 1}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Kilmain", 0, 0, 1}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Kleber", 2, 2, 1}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Lafayette", -1, 0, 1}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Lamarque", -3, 1, 1}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Lannes", 2, 3, 3}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Latour-Maubourg", -3, 2, 1}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Lauriston", -3, 0, 0}))

	gameData.Insert(DataMap("Commander", Commander{"France", "Lecourbe", -3, 1, 0}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Lefebvre", -1, 0, 1}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Lefebvre-Desnouettes", -3, 1, 1}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Legrande", -3, -1, 1}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Lescure", 0, 0, 1}))
	gameData.Insert(DataMap("Commander", Commander{"France", "L'hertier", -3, 0, 1}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Loison", -3, -1, 1}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Maison", 1, 1, 0}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Marmont", 1, 2, 1}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Massena - to 1800", 2, 3, 1}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Massena - after 1800", 1, 2, 0}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Macdonald", -1, 0, 0}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Marceau", 1, 1, 3}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Menou", -1, -1, -1}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Milhaud", -3, 0, 1}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Mouton (Loubau)", -3, 1, 1}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Moncey", 0, -1, 1}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Montbrun", -3, 2, 1}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Morand", -3, -1, 1}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Moreau", 1, 1, 1}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Mortier", -3, 0, 0}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Murat - to 1812", -1, 2, 3}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Murat - after 1812", -1, 1, 3}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Nansouty", -3, 1, 1}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Ney", 0, 1, 3}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Oudinot", -1, 0, 1}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Pajol", -3, 1, 1}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Perignon", 0, 0, 0}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Pichgru", 0, 0, 0}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Poniatowski", 0, 1, 3}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Rapp", 0, 1, 1}))

	gameData.Insert(DataMap("Commander", Commander{"France", "Reille", -1, 0, 1}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Reynier", -1, 0, 0}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Richepance", -3, 2, 1}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Rochejaquelein", 1, 1, 3}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Rossignol", -2, -2, -1}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Saint-Cyr", 1, 2, 0}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Sainte-Suzanne", -3, 0, 0}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Savary", -3, -1, 0}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Santerre", -2, -2, 0}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Sebastiani", -3, 0, 1}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Servan", -1, 0, 0}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Sokolnicki", -3, 1, 1}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Soult - to 1800", -3, 2, 1}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Soult - after 1800", 1, 2, -1}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Souham", -3, 0, 1}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Stofflet", 0, 0, 0}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Suchet", 2, 2, 0}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Talmont", -3, 1, 1}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Turreau", -2, -2, 0}))
	gameData.Insert(DataMap("Commander", Commander{"France", "d'Urbal", -3, -1, -1}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Vandamme", -1, 1, 1}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Verdier", -1, -1, 0}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Victor", -3, -1, 0}))
	gameData.Insert(DataMap("Commander", Commander{"France", "Walther", -3, 0, 0}))

	gameData.Insert(DataMap("Commander", Commander{"Britain", "Abercromby", 0, 0, 1}))
	gameData.Insert(DataMap("Commander", Commander{"Britain", "Baird", 0, 1, 0}))
	gameData.Insert(DataMap("Commander", Commander{"Britain", "Bentinck", 0, -1, 0}))
	gameData.Insert(DataMap("Commander", Commander{"Britain", "Beresford", 0, 0, -1}))
	gameData.Insert(DataMap("Commander", Commander{"Britain", "Brock", 1, 1, 1}))
	gameData.Insert(DataMap("Commander", Commander{"Britain", "Burrard", -2, -1, -1}))
	gameData.Insert(DataMap("Commander", Commander{"Britain", "Cathcart", -1, -1, -1}))

	gameData.Insert(DataMap("Commander", Commander{"Britain", "Chatham", -1, -1, 0}))
	gameData.Insert(DataMap("Commander", Commander{"Britain", "Clinton", 0, 0, 0}))
	gameData.Insert(DataMap("Commander", Commander{"Britain", "Cornwallis", 0, 0, 1}))
	gameData.Insert(DataMap("Commander", Commander{"Britain", "Craig", 0, 0, 0}))
	gameData.Insert(DataMap("Commander", Commander{"Britain", "Dalrymple", -2, -1, -1}))
	gameData.Insert(DataMap("Commander", Commander{"Britain", "Drummond", 0, 0, 0}))
	gameData.Insert(DataMap("Commander", Commander{"Britain", "Fraser", -1, 0, 0}))
	gameData.Insert(DataMap("Commander", Commander{"Britain", "Graham", -3, 1, 0}))
	gameData.Insert(DataMap("Commander", Commander{"Britain", "Grey", 0, 0, 0}))
	gameData.Insert(DataMap("Commander", Commander{"Britain", "Harris", 1, 1, 0}))
	gameData.Insert(DataMap("Commander", Commander{"Britain", "Hill", -3, 2, 1}))
	gameData.Insert(DataMap("Commander", Commander{"Britain", "Hope", -3, 0, 0}))
	gameData.Insert(DataMap("Commander", Commander{"Britain", "Hutchison", 1, 1, 0}))
	gameData.Insert(DataMap("Commander", Commander{"Britain", "Lake", 1, 1, 1}))
	gameData.Insert(DataMap("Commander", Commander{"Britain", "Maitland", 0, 0, 0}))
	gameData.Insert(DataMap("Commander", Commander{"Britain", "Moore", 0, 1, 1}))
	gameData.Insert(DataMap("Commander", Commander{"Britain", "Murray", -1, -1, -1}))
	gameData.Insert(DataMap("Commander", Commander{"Britain", "Packenham", 0, 1, 1}))
	gameData.Insert(DataMap("Commander", Commander{"Britain", "Paget (Uxbridge)", -3, 1, 1}))
	gameData.Insert(DataMap("Commander", Commander{"Britain", "E Paget", -3, 0, 1}))
	gameData.Insert(DataMap("Commander", Commander{"Britain", "Prince of Orange", -1, -1, -1}))
	gameData.Insert(DataMap("Commander", Commander{"Britain", "Proctor", -1, -1, -1}))
	gameData.Insert(DataMap("Commander", Commander{"Britain", "Riall", -1, -1, 0}))
	gameData.Insert(DataMap("Commander", Commander{"Britain", "Stapleton-Cotton", -3, 1, 1}))
	gameData.Insert(DataMap("Commander", Commander{"Britain", "Stuart", 0, 0, 0}))
	gameData.Insert(DataMap("Commander", Commander{"Britain", "Wellesley (Wellington)", 2, 2, 1}))
	gameData.Insert(DataMap("Commander", Commander{"Britain", "Whitlocke", -2, -2, 0}))
	gameData.Insert(DataMap("Commander", Commander{"Britain", "Duke of York - to 1795", -1, 1, 1}))
	gameData.Insert(DataMap("Commander", Commander{"Britain", "Duke of York - after 1795", -1, 1, 0}))

	gameData.Insert(DataMap("Commander", Commander{"Preussen", "Alvensleben", -2, -2, 0}))
	gameData.Insert(DataMap("Commander", Commander{"Preussen", "Blucher", 0, -1, 3}))
	gameData.Insert(DataMap("Commander", Commander{"Preussen", "Brunswick", 0, 0, 1}))
	gameData.Insert(DataMap("Commander", Commander{"Preussen", "Bulow", -3, 1, 0}))

	gameData.Insert(DataMap("Commander", Commander{"Preussen", "Prinz Louis", -1, -1, 1}))
	gameData.Insert(DataMap("Commander", Commander{"Preussen", "Hohenlohe", -2, -2, 0}))
	gameData.Insert(DataMap("Commander", Commander{"Preussen", "Kalkreuth", -3, -1, 0}))
	gameData.Insert(DataMap("Commander", Commander{"Preussen", "Kleist", -3, 0, 1}))
	gameData.Insert(DataMap("Commander", Commander{"Preussen", "L'Estocq", -3, 0, 1}))
	gameData.Insert(DataMap("Commander", Commander{"Preussen", "Mollendorf", -3, 0, 1}))
	gameData.Insert(DataMap("Commander", Commander{"Preussen", "Orange", -3, -2, 0}))
	gameData.Insert(DataMap("Commander", Commander{"Preussen", "Pirch I", -3, 0, 0}))
	gameData.Insert(DataMap("Commander", Commander{"Preussen", "Roeder", -1, -1, 0}))
	gameData.Insert(DataMap("Commander", Commander{"Preussen", "Ruchel", -3, -2, 0}))
	gameData.Insert(DataMap("Commander", Commander{"Preussen", "Schmettau", -3, -1, 0}))
	gameData.Insert(DataMap("Commander", Commander{"Preussen", "Tauentzein", -3, 1, 0}))
	gameData.Insert(DataMap("Commander", Commander{"Preussen", "Thielmann", -3, -1, 0}))
	gameData.Insert(DataMap("Commander", Commander{"Preussen", "Wartensleben", -3, -2, 0}))
	gameData.Insert(DataMap("Commander", Commander{"Preussen", "Prinz Wurtemberg", -1, -1, 0}))
	gameData.Insert(DataMap("Commander", Commander{"Preussen", "Yorck", -3, 1, 1}))
	gameData.Insert(DataMap("Commander", Commander{"Preussen", "Zeiten", -3, 1, 1}))

	gameData.Insert(DataMap("Commander", Commander{"Russia", "Alexander I", -1, -1, 3}))
	gameData.Insert(DataMap("Commander", Commander{"Russia", "Alsusiev", -3, -1, 0}))
	gameData.Insert(DataMap("Commander", Commander{"Russia", "Bagavout", -1, -1, 0}))
	gameData.Insert(DataMap("Commander", Commander{"Russia", "Bagration", 0, 1, 3}))
	gameData.Insert(DataMap("Commander", Commander{"Russia", "Barclay de Tolly", 0, 1, 0}))
	gameData.Insert(DataMap("Commander", Commander{"Russia", "Benningsen", -1, -1, 0}))
	gameData.Insert(DataMap("Commander", Commander{"Russia", "Berg", -3, 0, 0}))
	gameData.Insert(DataMap("Commander", Commander{"Russia", "Borosdin I", -3, -1, 0}))
	gameData.Insert(DataMap("Commander", Commander{"Russia", "Borosdin II", -3, -1, 1}))
	gameData.Insert(DataMap("Commander", Commander{"Russia", "Buxhowden", -2, -1, 0}))
	gameData.Insert(DataMap("Commander", Commander{"Russia", "Chichagov", 0, 0, 0}))
	gameData.Insert(DataMap("Commander", Commander{"Russia", "Constantine", -2, -1, 3}))
	gameData.Insert(DataMap("Commander", Commander{"Russia", "Czernichev", -3, -1, 0}))
	gameData.Insert(DataMap("Commander", Commander{"Russia", "d'Anrep", -3, -1, 0}))
	gameData.Insert(DataMap("Commander", Commander{"Russia", "Dolgorukov", -3, -1, 0}))
	gameData.Insert(DataMap("Commander", Commander{"Russia", "Docturov", -3, 0, 0}))

	gameData.Insert(DataMap("Commander", Commander{"Russia", "Derfelden", -3, 0, 1}))
	gameData.Insert(DataMap("Commander", Commander{"Russia", "Essen I", 0, 0, 0}))
	gameData.Insert(DataMap("Commander", Commander{"Russia", "Essen II", -3, 0, 0}))
	gameData.Insert(DataMap("Commander", Commander{"Russia", "Eugene of Wurttemburg", -3, 0, 1}))
	gameData.Insert(DataMap("Commander", Commander{"Russia", "Fock", -3, -1, 0}))
	gameData.Insert(DataMap("Commander", Commander{"Russia", "Galitzen", -3, 2, 1}))
	gameData.Insert(DataMap("Commander", Commander{"Russia", "Gorchakov II", -3, 0, 0}))
	gameData.Insert(DataMap("Commander", Commander{"Russia", "Hermann", -2, -2, 0}))
	gameData.Insert(DataMap("Commander", Commander{"Russia", "Kaminski", -3, -1, 0}))
	gameData.Insert(DataMap("Commander", Commander{"Russia", "Kapchewitch", -3, -1, 0}))
	gameData.Insert(DataMap("Commander", Commander{"Russia", "Konovnitzen", -3, 1, 1}))
	gameData.Insert(DataMap("Commander", Commander{"Russia", "Korff", -3, 0, 1}))
	gameData.Insert(DataMap("Commander", Commander{"Russia", "Kreutz", -3, -1, 0}))
	gameData.Insert(DataMap("Commander", Commander{"Russia", "Kutaisov", -3, 1, 1}))
	gameData.Insert(DataMap("Commander", Commander{"Russia", "Kutuzov", 0, 0, 0}))
	gameData.Insert(DataMap("Commander", Commander{"Russia", "Lacy", -2, -1, 0}))
	gameData.Insert(DataMap("Commander", Commander{"Russia", "Lambert", -3, -1, 0}))
	gameData.Insert(DataMap("Commander", Commander{"Russia", "Langeron", -3, 1, 1}))
	gameData.Insert(DataMap("Commander", Commander{"Russia", "Laptiev", -3, -1, 1}))
	gameData.Insert(DataMap("Commander", Commander{"Russia", "Lavrov", -3, 0, 0}))
	gameData.Insert(DataMap("Commander", Commander{"Russia", "Lieven", -3, 0, 0}))
	gameData.Insert(DataMap("Commander", Commander{"Russia", "Markov III", -3, -1, 0}))
	gameData.Insert(DataMap("Commander", Commander{"Russia", "Mildoravich", -3, 1, 1}))
	gameData.Insert(DataMap("Commander", Commander{"Russia", "Milesnov", -3, 0, 0}))
	gameData.Insert(DataMap("Commander", Commander{"Russia", "Numsen", -3, -1, 0}))
	gameData.Insert(DataMap("Commander", Commander{"Russia", "Olsuviev", -3, 0, 1}))
	gameData.Insert(DataMap("Commander", Commander{"Russia", "Ostermann-Tolstoi", -3, 1, 0}))
	gameData.Insert(DataMap("Commander", Commander{"Russia", "Pahlen I", -3, 1, 1}))
	gameData.Insert(DataMap("Commander", Commander{"Russia", "Pahlen III", -3, 0, 0}))
	gameData.Insert(DataMap("Commander", Commander{"Russia", "Platov", -3, -1, 3}))
	gameData.Insert(DataMap("Commander", Commander{"Russia", "Prevyshevsky", -3, 1, 1}))
	gameData.Insert(DataMap("Commander", Commander{"Russia", "Raevsky", -3, 2, 1}))
	gameData.Insert(DataMap("Commander", Commander{"Russia", "Rehbinder", -3, -1, 0}))
	gameData.Insert(DataMap("Commander", Commander{"Russia", "Rimsky-Korsakov", -2, -2, -1}))
	gameData.Insert(DataMap("Commander", Commander{"Russia", "Rosenberg", -3, 1, 1}))
	gameData.Insert(DataMap("Commander", Commander{"Russia", "Sacken", -3, 0, 1}))

	gameData.Insert(DataMap("Commander", Commander{"Russia", "St Priest", -3, 0, 1}))
	gameData.Insert(DataMap("Commander", Commander{"Russia", "Scherbatov", -3, -1, 0}))
	gameData.Insert(DataMap("Commander", Commander{"Russia", "Shauwalov", -3, 0, 0}))
	gameData.Insert(DataMap("Commander", Commander{"Russia", "Sievers", -3, 0, 1}))
	gameData.Insert(DataMap("Commander", Commander{"Russia", "Steingel", -1, 0, 0}))
	gameData.Insert(DataMap("Commander", Commander{"Russia", "Suverov", 2, 2, 1}))
	gameData.Insert(DataMap("Commander", Commander{"Russia", "Tchervoatov", -3, 0, 0}))
	gameData.Insert(DataMap("Commander", Commander{"Russia", "Tormasov", -3, 1, 1}))
	gameData.Insert(DataMap("Commander", Commander{"Russia", "Tscaplitz", -3, 0, 0}))
	gameData.Insert(DataMap("Commander", Commander{"Russia", "Tuchkov I", -3, 1, 1}))
	gameData.Insert(DataMap("Commander", Commander{"Russia", "Uvarov", -3, 0, 0}))
	gameData.Insert(DataMap("Commander", Commander{"Russia", "Vassilshikov", -3, 0, 0}))
	gameData.Insert(DataMap("Commander", Commander{"Russia", "Voinov", -3, 0, 0}))
	gameData.Insert(DataMap("Commander", Commander{"Russia", "Voronsov", -3, 1, 1}))
	gameData.Insert(DataMap("Commander", Commander{"Russia", "Wallmoden", -3, -1, 0}))
	gameData.Insert(DataMap("Commander", Commander{"Russia", "Wintzingerode", -1, 0, 0}))
	gameData.Insert(DataMap("Commander", Commander{"Russia", "Wittgenstein", -3, 1, 1}))
	gameData.Insert(DataMap("Commander", Commander{"Russia", "Yermolov", -3, 2, 1}))

	gameData.Insert(DataMap("Commander", Commander{"Austria", "Alvintzy", -1, -1, 0}))
	gameData.Insert(DataMap("Commander", Commander{"Austria", "Beaulien", -1, -1, 0}))
	gameData.Insert(DataMap("Commander", Commander{"Austria", "Bellegarde", -1, 0, 0}))
	gameData.Insert(DataMap("Commander", Commander{"Austria", "Bianchi", 0, 0, 0}))
	gameData.Insert(DataMap("Commander", Commander{"Austria", "Bubna", -3, -2, 0}))
	gameData.Insert(DataMap("Commander", Commander{"Austria", "ERZ Charles (Karl)", 2, 1, 1}))
	gameData.Insert(DataMap("Commander", Commander{"Austria", "Chasteler", 0, 0, 1}))
	gameData.Insert(DataMap("Commander", Commander{"Austria", "Clerfayt", -2, -1, 1}))
	gameData.Insert(DataMap("Commander", Commander{"Austria", "H Colloredo", -3, -2, 0}))
	gameData.Insert(DataMap("Commander", Commander{"Austria", "J Colloredo", -3, -1, 0}))
	gameData.Insert(DataMap("Commander", Commander{"Austria", "Davidovitch", -2, -1, 0}))
	gameData.Insert(DataMap("Commander", Commander{"Austria", "ERZ Ferdinand", -2, 1, 0}))
	gameData.Insert(DataMap("Commander", Commander{"Austria", "Frimont", -3, -1, 0}))
	gameData.Insert(DataMap("Commander", Commander{"Austria", "Gyulai", -3, 1, 0}))
	gameData.Insert(DataMap("Commander", Commander{"Austria", "Hessen-Homberg", -3, 1, 1}))

	gameData.Insert(DataMap("Commander", Commander{"Austria", "Hiller", -1, -2, 0}))
	gameData.Insert(DataMap("Commander", Commander{"Austria", "Hohenzollern", -3, 0, 0}))
	gameData.Insert(DataMap("Commander", Commander{"Austria", "Hoffer", 0, 0, 1}))
	gameData.Insert(DataMap("Commander", Commander{"Austria", "Jellanic", -3, -2, 0}))
	gameData.Insert(DataMap("Commander", Commander{"Austria", "HRZ Johann", -1, -1, 0}))
	gameData.Insert(DataMap("Commander", Commander{"Austria", "HRZ Joseph", 0, 1, 1}))
	gameData.Insert(DataMap("Commander", Commander{"Austria", "Kaim", -3, 0, 0}))
	gameData.Insert(DataMap("Commander", Commander{"Austria", "Kiemeyer", -3, 0, 0}))
	gameData.Insert(DataMap("Commander", Commander{"Austria", "Klenau", -3, -2, 0}))
	gameData.Insert(DataMap("Commander", Commander{"Austria", "Kollowrat", -3, -1, 0}))
	gameData.Insert(DataMap("Commander", Commander{"Austria", "Kray", 1, 1, 1}))
	gameData.Insert(DataMap("Commander", Commander{"Austria", "Liechenstein", -3, 1, 1}))
	gameData.Insert(DataMap("Commander", Commander{"Austria", "HRZ Louis", -1, -1, 0}))
	gameData.Insert(DataMap("Commander", Commander{"Austria", "Mack", -2, -2, 0}))
	gameData.Insert(DataMap("Commander", Commander{"Austria", "Melas", -1, -1, -1}))
	gameData.Insert(DataMap("Commander", Commander{"Austria", "Merveldt", -3, 1, 0}))
	gameData.Insert(DataMap("Commander", Commander{"Austria", "Meszaros", -3, 0, 1}))
	gameData.Insert(DataMap("Commander", Commander{"Austria", "Neiperg", -3, 0, 0}))
	gameData.Insert(DataMap("Commander", Commander{"Austria", "Nostitz", -3, 1, 1}))
	gameData.Insert(DataMap("Commander", Commander{"Austria", "Nugent", -3, 0, 0}))
	gameData.Insert(DataMap("Commander", Commander{"Austria", "Ott", -3, 1, 1}))
	gameData.Insert(DataMap("Commander", Commander{"Austria", "Quasdanovich", -3, -1, 0}))
	gameData.Insert(DataMap("Commander", Commander{"Austria", "Radetzsky", -3, 1, 1}))
	gameData.Insert(DataMap("Commander", Commander{"Austria", "Reuss-Plauen", -3, -2, 0}))
	gameData.Insert(DataMap("Commander", Commander{"Austria", "Rosenberg", -3, -1, 0}))
	gameData.Insert(DataMap("Commander", Commander{"Austria", "St Julien", -2, -2, 0}))
	gameData.Insert(DataMap("Commander", Commander{"Austria", "Schwarzenberg", 0, 1, 0}))
	gameData.Insert(DataMap("Commander", Commander{"Austria", "Sommariva", -3, -1, 0}))
	gameData.Insert(DataMap("Commander", Commander{"Austria", "Wimpffen", -3, -1, 0}))
	gameData.Insert(DataMap("Commander", Commander{"Austria", "Zach", -3, -1, 1}))

	gameData.Insert(DataMap("Commander", Commander{"Spain", "Blake", -3, 0, 1}))
	gameData.Insert(DataMap("Commander", Commander{"Spain", "Ballesteros", -2, -2, 0}))
	gameData.Insert(DataMap("Commander", Commander{"Spain", "Castanos", -3, 1, 1}))
	gameData.Insert(DataMap("Commander", Commander{"Spain", "De La Cuesta", -2, -2, 3}))
	gameData.Insert(DataMap("Commander", Commander{"Spain", "Henestrosa", -3, -1, 0}))
	gameData.Insert(DataMap("Commander", Commander{"Spain", "Palafox", -3, 1, 3}))
	gameData.Insert(DataMap("Commander", Commander{"Spain", "Romana", -3, 0, 0}))

	gameData.Insert(DataMap("Commander", Commander{"Naples", "King Murat", -1, 0, 3}))
	gameData.Insert(DataMap("Commander", Commander{"Naples", "Pignatelli-Strongoli", -3, -2, 0}))
	gameData.Insert(DataMap("Commander", Commander{"Naples", "Livron", -3, -2, 0}))
	gameData.Insert(DataMap("Commander", Commander{"Naples", "Carrascossa", -3, -1, 0}))
	gameData.Insert(DataMap("Commander", Commander{"Naples", "Damas", -3, -1, 0}))
	gameData.Insert(DataMap("Commander", Commander{"Naples", "d'Ambrosio", -3, -1, 0}))
	gameData.Insert(DataMap("Commander", Commander{"Naples", "Lechi", -3, 1, 1}))
	gameData.Insert(DataMap("Commander", Commander{"Naples", "Rosetti", -3, 0, 1}))
	gameData.Insert(DataMap("Commander", Commander{"Naples", "Pignatelli-Cerchiara", -3, -1, 0}))

	gameData.Insert(DataMap("Commander", Commander{"Sweden", "Bernadotte", 0, 0, 1}))
	gameData.Insert(DataMap("Commander", Commander{"Sweden", "Essen", 1, 1, 1}))
	gameData.Insert(DataMap("Commander", Commander{"Sweden", "Stedinok", 1, 1, 1}))

	gameData.Insert(DataMap("Commander", Commander{"Ottoman", "Selim III", -1, 0, 1}))
	gameData.Insert(DataMap("Commander", Commander{"Ottoman", "Mahmud II", -2, -1, -1}))
	gameData.Insert(DataMap("Commander", Commander{"Ottoman", "Ali Pasha", 0, 1, 1}))
	gameData.Insert(DataMap("Commander", Commander{"Ottoman", "Ahmet Cezzar Pasha", 0, 0, 1}))
	gameData.Insert(DataMap("Commander", Commander{"Ottoman", "Grand Viser", -1, 0, 1}))
	gameData.Insert(DataMap("Commander", Commander{"Ottoman", "Ibrahim Bey", -2, -1, 1}))
	gameData.Insert(DataMap("Commander", Commander{"Ottoman", "Mehmet Ali", 1, 0, 1}))
	gameData.Insert(DataMap("Commander", Commander{"Ottoman", "Murad Bey", -2, 0, 1}))
	gameData.Insert(DataMap("Commander", Commander{"Ottoman", "Omar Agha", -3, 1, 1}))
	gameData.Insert(DataMap("Commander", Commander{"Ottoman", "Pachlivan Khan", -1, -1, 3}))

	gameData.Insert(DataMap("Commander", Commander{"United States", "Brown", 0, 0, 0}))
	gameData.Insert(DataMap("Commander", Commander{"United States", "Jackson", 1, 0, 1}))
	gameData.Insert(DataMap("Commander", Commander{"United States", "Harrison", 1, 0, 1}))
	gameData.Insert(DataMap("Commander", Commander{"United States", "Scott", 0, 0, 1}))
	gameData.Insert(DataMap("Commander", Commander{"United States", "Wilkinson", -1, 0, -1}))

	gameData.Insert(DataMap("Commander", Commander{"Poland", "Kosciuszko", 1, 0, 3}))
	gameData.Insert(DataMap("Commander", Commander{"Other", "St Martin", 1, 0, 1}))
	gameData.Insert(DataMap("Commander", Commander{"Other", "Bolivar", 1, 0, 3}))
	gameData.Insert(DataMap("Commander", Commander{"Piedmont", "Colli", -1, 0, 0}))
	gameData.Insert(DataMap("Commander", Commander{"Hyderabad", "Raymond", -2, -2, -1}))
	gameData.Insert(DataMap("Commander", Commander{"Denmark", "Frederick of Hesse", 1, 1, 0}))
	gameData.Insert(DataMap("Commander", Commander{"Denmark", "During", -3, 0, 1}))
	gameData.Insert(DataMap("Commander", Commander{"Bavaria", "Wrede", -1, 0, 0}))
	gameData.Insert(DataMap("Commander", Commander{"Wurttemberg", "Crown Prince of Wurttemberg", -3, 0, 1}))
	gameData.Insert(DataMap("Commander", Commander{"Saxony", "Weimar", -3, -1, 0}))
	gameData.Insert(DataMap("Commander", Commander{"Persia", "Agha Mohammad Khan", 1, 1, 1}))
	gameData.Insert(DataMap("Commander", Commander{"Persia", "Fath Ali Shah", -1, -1, 0}))
