	...
	for {
		...
		case "Simulator":
			...
			case "ArtyFire":
				...
				sendAll(msg)
			case "ArtyBB":
				results := simulation.ArtyBB(gameData, RxMsg["Data"].(map[string]interface{}))
				msg, _ = json.Marshal(list.MessageFormat{"Simulate", theEntity, results})
				sendAll(msg)
			case "CounterBty":
				results := simulation.CounterBty(gameData, RxMsg["Data"].(map[string]interface{}))
				msg, _ = json.Marshal(list.MessageFormat{"Simulate", theEntity, results})
				sendAll(msg)
			case "Aflame":
				results := simulation.Aflame(gameData, RxMsg["Data"].(map[string]interface{}))
				msg, _ = json.Marshal(list.MessageFormat{"Simulate", theEntity, results})
				sendAll(msg)
			...
			case "MEPanicTest":
				...
				msg, _ = json.Marshal(list.MessageFormat{"Simulate", theEntity, results})
				sendAll(msg)
			case "FireDisciplineTest":
				results := simulation.FireDisciplineTest(gameData, RxMsg["Data"].(map[string]interface{}))
				msg, _ = json.Marshal(list.MessageFormat{"Simulate", theEntity, results})
				sendAll(msg)
			case "BadMoraleRec":
				results := simulation.BadMoraleRec(gameData, RxMsg["Data"].(map[string]interface{}))
				msg, _ = json.Marshal(list.MessageFormat{"Simulate", theEntity, results})
				sendAll(msg)
			...
			case "CorpsOrder":
				...
				sendAll(msg)
			case "MEOrder":
				results := simulation.MEOrder(gameData, RxMsg["Data"].(map[string]interface{}))
				msg, _ = json.Marshal(list.MessageFormat{"Simulate", theEntity, results})
				sendAll(msg)
			case "OrderActivation":
				results := simulation.OrderActivation(gameData, RxMsg["Data"].(map[string]interface{}))
				msg, _ = json.Marshal(list.MessageFormat{"Simulate", theEntity, results})
				sendAll(msg)
			case "CommanderAction":
				results := simulation.CommanderAction(gameData, RxMsg["Data"].(map[string]interface{}))
				msg, _ = json.Marshal(list.MessageFormat{"Simulate", theEntity, results})
				sendAll(msg)
			case "BonusImpulse":
				results := simulation.BonusImpulse(gameData, RxMsg["Data"].(map[string]interface{}))
				msg, _ = json.Marshal(list.MessageFormat{"Simulate", theEntity, results})
				sendAll(msg)
			...
			case "FormSquare":
				...
				sendAll(msg)
			case "ArtLimber":
				results := simulation.ArtLimber(gameData, RxMsg["Data"].(map[string]interface{}))
				msg, _ = json.Marshal(list.MessageFormat{"Simulate", theEntity, results})
				sendAll(msg)
			case "DefFire":
				results := simulation.DefFire(gameData, RxMsg["Data"].(map[string]interface{}))
				msg, _ = json.Marshal(list.MessageFormat{"Simulate", theEntity, results})
				sendAll(msg)
			case "StreetFight":
				results := simulation.StreetFight(gameData, RxMsg["Data"].(map[string]interface{}))
				msg, _ = json.Marshal(list.MessageFormat{"Simulate", theEntity, results})
				sendAll(msg)
			case "LeaderDeath":
